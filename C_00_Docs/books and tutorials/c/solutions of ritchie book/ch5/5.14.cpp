...
{ 
    ...
    if(reverse)
     if(fold)
       rqsort((void **)line_ptr,0,lines-1,(int (*)(void * ,void *))( number>0 ? numcmp:istrcomp));
     else
       qsort((void **)line_ptr,0,lines-1,(int (*)(void * ,void *))( number>0 ? numcmp:strcomp));
    else
    if(fold)
      qsort((void **)line_ptr,0,lines-1,(int (*)(void * ,void *))( number>0 ? numcmp:istrcomp));
    else
      qsort((void **)line_ptr,0,lines-1,(int (*)(void * ,void *))( number>0 ? numcmp:strcomp));
